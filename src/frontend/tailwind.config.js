  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "india-green": {
          DEFAULT: "oklch(var(--india-green))",
          dark: "oklch(var(--india-green-dark))",
        },
        navy: {
      ...
      boxShadow: {
        ...
        card: "0 2px 12px 0 rgba(0,0,64,0.08)",
        "card-hover": "0 4px 24px 0 rgba(0,0,64,0.12)",
        saffron: "0 4px 16px 0 rgba(255,153,51,0.35)",
        green: "0 4px 16px 0 rgba(19,136,8,0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
